...
awful.spawn.easy_async("setxkbmap -model pc104 -layout us,ru,ua -option grp:alt_shift_toggle",function()
end)
awful.spawn.easy_async("picom",function()
end)
awful.spawn.easy_async("feh --bg-fill /home/anatolii/walls/1358326.png",function()
end)
-- {{{ Error handling
...
globalkeys = gears.table.join(
    ...
    awful.key({modkey}, "l", function ()
                awful.spawn.easy_async("betterlockscreen -l", function()
    ...
    awful.key({modkey, "Shift"}, "z", function ()
            ...
            end,{description = "Player", group = "client"}),
    ...
    awful.key({modkey, "Shift"}, "d", function ()
            ...
            end,{description = "rofi", group = "client"}),
